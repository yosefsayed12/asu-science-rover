...
const committees = {
    ...
    hr: {
        ...
        description: "مسؤولة عن متابعة افراد العشيرة وسجلاتهم",
    ...
    pr: {
        ...
        description: "مسئوولة عن تنظيم الانشطة التطوعية التي تهدف لخدمة المجتمع.",

        tasks: ["تنظيم الانشطة التطوعية",
                "تنظيم حملات ارشادية في الكلية"],
    ...
    finan: {
        ...
        skills: "تحمل المسؤولية- التخطيط المالي - اتخاذ القرارات - ادارة المال"
    }
};
